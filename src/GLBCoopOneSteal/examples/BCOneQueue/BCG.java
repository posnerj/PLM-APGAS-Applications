 ...
 */
package GLBCoopOneSteal.examples.BCOneQueue;
...
import GLBCoop.examples.BCOneQueue.Queue;
...
public class BCG {
  ...
  private static Double[] compute(String[] args) throws ParseException {
    ...
    GLBCoopOneSteal<Queue, Double> glb = new GLBCoopOneSteal<Queue, Double>(init, glbPara, false);
