 ...
 */
package GLBCoopOneSteal.examples.SyntheticBenchmark;
...
import GLBCoop.examples.SyntheticBenchmark.Queue;
...
public class SyntheticG {
  ...
  public static Long[] compute(String[] args) throws ParseException {
    ...
    if (staticMode) {
      ...
      GLBCoopOneSteal<Queue, Long> glb = new GLBCoopOneSteal<Queue, Long>(init, glbPara, false);
