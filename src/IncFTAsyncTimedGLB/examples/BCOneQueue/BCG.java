...
public class BCG {
  ...
  private static Double[] compute(String[] args) throws ParseException {
    ...
    int n = Integer.parseInt(cmd.getOptionValue("n", "15")); // 2
    ...
    IncFTTimedGLBParameters glbPara =
        new IncFTTimedGLBParameters(
            g, w, l, z, m, verbose, timestamps, s, crashNumber, backupCount, numPlaces);
    IncFTTimedGLB<Queue, Double> glb = new IncFTTimedGLB<Queue, Double>(init, glbPara, false);
