 ...
 */
package IncFTAsyncTimedGLB.examples.SyntheticBenchmark;

import static IncFTGLB.IncFTGLBParameters.computeL;
import static IncFTGLB.IncFTGLBParameters.computeZ;
import static apgas.Constructs.places;

import IncFTGLB.examples.SyntheticBenchmark.Queue;
import IncFTTimedGLB.IncFTTimedGLB;
import IncFTTimedGLB.IncFTTimedGLBParameters;
...
public class SyntheticG {
  ...
  public static Long[] compute(String[] args) throws ParseException {
    ...
    int t = Integer.parseInt(cmd.getOptionValue("t", String.valueOf(4000)));
    int c = Integer.parseInt(cmd.getOptionValue("c", "22"));
    int g = Integer.parseInt(cmd.getOptionValue("g", "50000"));
    ...
    int verbose =
        Integer.parseInt(
            cmd.getOptionValue("v", String.valueOf(IncFTTimedGLBParameters.SHOW_RESULT_FLAG)));
    ...
    if (staticMode) {
      ...
      IncFTTimedGLBParameters glbPara =
          new IncFTTimedGLBParameters(
              n, w, l, z, m, verbose, timestamps, s, crashNumber, backupCount, numPlaces);
      IncFTTimedGLB<Queue, Long> glb = new IncFTTimedGLB<Queue, Long>(init, glbPara, false);
      ...
      IncFTTimedGLBParameters glbPara =
          new IncFTTimedGLBParameters(
              n, w, l, z, m, verbose, timestamps, s, crashNumber, backupCount, numPlaces);
      IncFTTimedGLB<Queue, Long> glb = new IncFTTimedGLB<Queue, Long>(init, glbPara, true);
