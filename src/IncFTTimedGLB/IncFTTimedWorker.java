 ...
 * @param <T> Result type.
 */
public final class IncFTTimedWorker<Queue extends IncFTTaskQueue<Queue, T>, T extends Serializable>
   ...
   * Class constructor
   *
   * @param init function closure to init the local {@link IncFTTimedWorker}
  ...
  /**
   * Internal method used by {@link IncFTTimedGLB} to start FTWorker at each place when the workload
   * is known statically.
   */
   ...
   *
   * @param start init method used in {@link IncFTTimedWorker}, note the workload is not allocated,
